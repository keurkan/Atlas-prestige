...
export default function AtlasFly() {
    const { t } = useLanguage();
        ...
        <div className="min-h-screen bg-background pt-20">
            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0">
                    <img
                        src="/images/atlas_fly.jpeg"
                        alt={t('services.items.fly.title')}
                    ...
                    <ScrollReveal>
                        <div className="prose prose-lg dark:prose-invert mx-auto">
                            ...
                            <div className="space-y-6 text-muted-foreground font-light leading-relaxed">
                                ...
                                <p>
                                    {t('atlasFly.paragraph2')}
                                </p>
                                <div className="mt-12 p-8 bg-secondary rounded-lg">
                                    <h3 className="font-serif text-xl text-foreground mb-4">
                                        {t('atlasFly.featuresTitle')}
                                    </h3>
                                    <ul className="space-y-3">
                                        <li className="flex items-center gap-3">
                                            <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                                            <span>{t('atlasFly.features.1')}</span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                                            <span>{t('atlasFly.features.2')}</span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                                            <span>{t('atlasFly.features.3')}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
