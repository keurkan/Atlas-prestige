...
export default function AtlasStay() {
    const { t } = useLanguage();
            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0">
                    <img
                        ...
                        alt={t('services.items.stay.title')}
                ...
                <div className="container-custom max-w-4xl">
                    <ScrollReveal>
                        <div className="prose prose-lg dark:prose-invert mx-auto">
                            ...
                            <img
                                src="/images/atlas_stay_desc_1.jpg"
                                alt="Hotel du Golf Exterior"
                                className="w-full aspect-video object-cover rounded-lg mb-8 shadow-sm"
                            />

                            <div className="space-y-6 text-muted-foreground font-light leading-relaxed">
                                <p>
                                    {t('atlasStay.paragraph1')}
                                </p>

                                <img
                                    src="/images/atlas_stay_desc_2.jpg"
                                    alt="Luxury Villa Interior"
                                    className="w-full aspect-video object-cover rounded-lg my-8 shadow-sm"
                                />

                                <p>
                                    {t('atlasStay.paragraph2')}
                                </p>
                                <div className="mt-12 p-8 bg-secondary rounded-lg">
                                    <h3 className="font-serif text-xl text-foreground mb-4">
                                        {t('atlasStay.featuresTitle')}
                                    </h3>
                                    <ul className="space-y-3">
                                        <li className="flex items-center gap-3">
                                            <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                                            <span>{t('atlasStay.features.1')}</span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                                            <span>{t('atlasStay.features.2')}</span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                                            <span>{t('atlasStay.features.3')}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
