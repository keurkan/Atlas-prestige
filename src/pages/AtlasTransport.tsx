...
export default function AtlasTransport() {
    const { t } = useLanguage();
            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0">
                    <img
                        ...
                        alt={t('services.items.transport.title')}
                ...
                <div className="relative z-10 text-center text-white px-4 mt-20">
                    ...
                    <ScrollReveal delay={0.2}>
                        <p className="max-w-2xl mx-auto text-lg md:text-xl font-light opacity-90">
                            {t('services.items.transport.description')}
                        </p>
                    </ScrollReveal>
                </div>
            </section>
                            ...
                            <div className="space-y-6 text-muted-foreground font-light leading-relaxed">
                                ...
                                <div className="mt-12 p-8 bg-secondary rounded-lg">
                                    <h3 className="font-serif text-xl text-foreground mb-4">
                                        {t('atlasTransport.featuresTitle')}
                                    </h3>
                                    <ul className="space-y-3">
                                        <li className="flex items-center gap-3">
                                            <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                                            <span>{t('atlasTransport.features.1')}</span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                                            <span>{t('atlasTransport.features.2')}</span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                                            <span>{t('atlasTransport.features.3')}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
