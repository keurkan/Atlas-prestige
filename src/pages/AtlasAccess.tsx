...
export default function AtlasAccess() {
    const { t } = useLanguage();
            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0">
                    <img
                        ...
                        alt={t('services.items.access.title')}
                                ...
                                <div className="mt-12 p-8 bg-secondary rounded-lg">
                                    ...
                                    <ul className="space-y-3">
                                        <li className="flex items-center gap-3">
                                            ...
                                            <span>{t('atlasAccess.features.1')}</span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                                            <span>{t('atlasAccess.features.2')}</span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                                            <span>{t('atlasAccess.features.3')}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
